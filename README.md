...
В комплекте — мини-приложение для ученика и кабинет педагога: тёмная тема
«Cosmic Purple + Neon Teal», без сборки и без фронтенд-фреймворков.
...
| HTTP | httpx (async) |
| Фронтенд | Статика без сборки: HTML + ванильный JS, тёмная тема «Cosmic Purple + Neon Teal» |
...
- **Ничего из MAX не проверено на живой платформе** — доступа к ней пока нет.
  Вход в мини-приложение и разбор событий бота написаны по документации
  dev.max.ru; подпись initData проверяется тем же алгоритмом, что и в Telegram
