...
class Settings(BaseSettings):
    ...
    # Два разных адреса, и доступны они не из одних и тех же мест: base_url
    # отдаёт ответы модели, auth_url меняет Authorization key на токен. С
    # зарубежного хостинга второй может не отвечать вовсе — тогда оба
    # переставляются на обратный прокси в России, см. README.
